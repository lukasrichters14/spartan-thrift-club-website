...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppConnectConnectComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ConnectComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 27,
      vars: 0,
      consts: [[1, "heading"], [1, "buttons"], ["routerLink", "/home", 1, "main-button"], ["routerLink", "/events", 1, "main-button"], [1, "main"], [1, "socials"], ["href", "https://discord.gg/8EnJfpg4FQ", "target", "_blank"], ["type", "image", "src", "/assets/discord.png", "alt", "Discord icon"], ["href", "https://www.instagram.com/spartan.thrift.club/", "target", "_blank"], ["type", "image", "src", "/assets/instagram.png", "alt", "Instagram icon"], ["href", "https://twitter.com/SpartanThrift", "target", "_blank"], ["type", "image", "src", "/assets/twitter.png", "alt", "Twitter icon"], ["href", "https://www.facebook.com/Spartan.Thrift.Club", "target", "_blank"], ["type", "image", "src", "/assets/facebook.png", "alt", "Facebook icon"], [1, "centered-button"], ["href", "https://msu.campuslabs.com/engage/organization/spartanthrift", "id", "join-button", "target", "_blank", 1, "main-button"]],
  ...
  function srcAppEventsEventsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EventsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 62,
      vars: 0,
      consts: [[1, "heading"], [1, "buttons"], ["routerLink", "/home", 1, "main-button"], ["routerLink", "/connect", 1, "main-button"], [1, "main"], ["id", "upcoming"], [1, "event-left"], ["src", "assets/Logo.png", "alt", "A green circle that says 'Spartan Thrift\n    Club'.", "height", "200", "width", "200", 1, "event-img-left"], [1, "textbox"], ["href", "https://msu.zoom.us/j/91838864439", "target", "_blank"], ["id", "past"], ["src", "assets/annarbor.jpg", "alt", "A man hugging three boxes", 1, "event-img-left"], ["href", "https://ragstock.com/", "target", "_blank"], ["href", "http://www.a2ptothriftshop.org/", "target", "_blank"], [1, "event-right"], ["src", "assets/saginaw.png", "alt", "Two men posing for a photo", 1, "event-img-right-mobile"], ["href", "https://undergroundrailroadinc.org/underground-railroad-resale.html", "target", "_blank"], ["src", "assets/saginaw.png", "alt", "Two men posing for a photo", 1, "event-img-right"]],
    ...
    var UnsubscribeComponent = /*#__PURE__*/function () {
      ...
      _createClass(UnsubscribeComponent, [{
        ...
        value: function UnsubscribeEmail(pageUrl) {
          ...
          var params = pageUrl.substring(pageUrl.indexOf('?') + 1);
          var email = params.substring(params.indexOf('=') + 1); // Format email so it can query the database.
          ...
          email = tempEmail;
          var database = this.firebase.database; // Check database for email.

          database.ref('email-list/' + email).once('value').then(function (snapshot) {
            // Remove email from the database.
            database.ref('email-list/' + email).remove().then(function (value) {
              console.log("Removed");
            });
          });
        }
